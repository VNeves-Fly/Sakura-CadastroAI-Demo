...
import {
  ...
  type FiltroPeriodoAgencia,
} from "@/modules/agencias-crm/stores/filtro-periodo-agencia.store";

const DIAS_SEMANA = ["DOM", "SEG", "TER", "QUA", "QUI", "SEX", "SÁB"];
const FORMATO = "dd/MM/yyyy";

const ATALHOS: { valor: FiltroPeriodoAgencia; label: string }[] = [
  { valor: "dia", label: "Dia" },
...
const LABEL_ATALHO: Record<Exclude<FiltroPeriodoAgencia, "personalizado">, string> = {
  dia: "Dia",
  ontem: "Ontem",
  mes: "Mês",
  ano: "Ano",
...
// Grade de um mês — mesma lógica de filtro-periodo-executivo-popover.tsx,
// duplicada aqui de propósito por isolamento de módulo.
...
export function FiltroPeriodoAgenciaPopover({ sicaCodigo }: { sicaCodigo: string | null }) {
  ...
  function selecionarAtalho(valor: FiltroPeriodoAgencia) {
    setFiltro(valor);
    setAberto(false);
  }
