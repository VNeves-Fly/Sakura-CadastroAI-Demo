...
// envolvido, só serve os dados que já estão na tela. Duplicado de
// propósito do utilitário homônimo em dashboard-vendas (mesmo princípio
// de isolamento entre módulos já documentado no resto do projeto).
