...
// gestor-dashboard-view.tsx) — mesmo miolo visual de card do resto do
// dashboard, só com `Skeleton` no lugar do conteúdo real. Cópia local do
// equivalente em atribuicoes/components/executivo/dashboard/secao-skeleton.tsx
// (evita acoplar este módulo a outro só por um componente de skeleton).
