...
interface GestorAgenciaSegmentoModalProps {
  aberto: boolean;
...
// Modal padrão "ver lista" (cross-canal e saúde da carteira) — mesmo
// componente do dashboard de Executivo (busca + tabela + paginação).
export function GestorAgenciaSegmentoModal({
  aberto,
  onOpenChange,
  titulo,
  agencias,
}: GestorAgenciaSegmentoModalProps) {
