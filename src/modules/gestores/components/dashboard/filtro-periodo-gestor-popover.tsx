...
import {
  ...
  type FiltroPeriodoGestor,
} from "@/modules/gestores/stores/filtro-periodo-gestor.store";

const DIAS_SEMANA = ["DOM", "SEG", "TER", "QUA", "QUI", "SEX", "SÁB"];
const FORMATO = "dd/MM/yyyy";

const ATALHOS: { valor: FiltroPeriodoGestor; label: string }[] = [
  { valor: "dia", label: "Dia" },
...
const LABEL_ATALHO: Record<Exclude<FiltroPeriodoGestor, "personalizado">, string> = {
  dia: "Dia",
  ontem: "Ontem",
  mes: "Mês",
  ano: "Ano",
...
// — mesma lógica de filtro-periodo-executivo-popover.tsx, duplicada aqui
// de propósito por isolamento de módulo.
...
export function FiltroPeriodoGestorPopover({
  ...
  function selecionarAtalho(valor: FiltroPeriodoGestor) {
    setFiltro(valor);
    setAberto(false);
  }
