...
import type { CreatedUserResult } from "@/modules/users/types/user.types";
...
export function CreateUserSuccess({ result, onDismiss }: CreateUserSuccessProps) {
  ...
  return (
    <div className="border-primary/30 bg-primary/5 relative flex flex-col gap-2 rounded-[1.5rem] border p-5">
      ...
      <p className="text-foreground pr-6 text-sm font-semibold">
        Usuário {result.user.firstName} {result.user.lastName} criado com sucesso.
      </p>
