...
export class PrismaUserRepository implements UserRepository {
  ...
  async updatePassword(id: string, passwordHash: string): Promise<void> {
    ...
    // por OTP) invalida tokens de recuperação pendentes do usuário — sem
    // isso, um OTP emitido continuaria válido por até OTP_TTL_MINUTES
    // depois da senha já ter mudado por outra via.
