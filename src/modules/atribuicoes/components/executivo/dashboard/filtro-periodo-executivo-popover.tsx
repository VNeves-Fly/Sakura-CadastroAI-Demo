...
import {
  ...
  type FiltroPeriodoExecutivo,
} from "@/modules/atribuicoes/stores/filtro-periodo-executivo.store";

const DIAS_SEMANA = ["DOM", "SEG", "TER", "QUA", "QUI", "SEX", "SÁB"];
const FORMATO = "dd/MM/yyyy";

const ATALHOS: { valor: FiltroPeriodoExecutivo; label: string }[] = [
  { valor: "dia", label: "Dia" },
...
const LABEL_ATALHO: Record<Exclude<FiltroPeriodoExecutivo, "personalizado">, string> = {
  dia: "Dia",
  ontem: "Ontem",
  mes: "Mês",
  ano: "Ano",
...
// — mesma lógica de filtro-periodo-dashboard-popover.tsx (dashboard-vendas)
// e personalizado-date-range.tsx, duplicada aqui de propósito por
// isolamento de módulo (ver comentário da store).
...
export function FiltroPeriodoExecutivoPopover({
  ...
  function selecionarAtalho(valor: FiltroPeriodoExecutivo) {
    setFiltro(valor);
    setAberto(false);
  }
