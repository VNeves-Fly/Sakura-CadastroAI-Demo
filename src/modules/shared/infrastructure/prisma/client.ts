...
// O engine antigo do Prisma interpretava `?schema=` na connection string pra
// definir o search_path; o driver `pg` não conhece essa convenção, então
// precisamos repassar o schema explicitamente pro adapter.
